  ...
  return (
    <header className="sticky top-0 z-50 bg-cream/80 backdrop-blur-md border-b border-bone/60">
      <div className="mx-auto max-w-[1200px] px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex w-fit items-center justify-center gap-[7.5px] rounded-[5px] bg-[#1a1030]">
          {NAV_LINKS.map((l) => (
            <Link
              key={l.label}
              to={l.to as any}
              ...
              className={[
                ...
                "before:pointer-events-none before:absolute before:right-0 before:bottom-0 before:h-[3px] before:w-full before:rounded-[5px] before:bg-[#8B5CF6] before:content-[''] before:opacity-0 before:transition-opacity before:duration-200",
                "[&:not(:active):not(.active-link):hover]:bg-[#2a1f40]",
                "[&:focus:not(.active-link)]:bg-[#2a1f40]",
                "focus:bg-[#231845] active:bg-[#231845] [&.active-link]:bg-[#231845]",
