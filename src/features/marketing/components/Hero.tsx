    ...
    const ctx = gsap.context(() => {
      ...
      if (!isReduced) {
        ...
        tl.fromTo(
          ...
          .fromTo(".hero-cta", { opacity: 0, y: 14 }, { opacity: 1, y: 0, duration: 0.6 }, "-=0.45")
          .fromTo(
            ".hero-float-svg",
  ...
  if (type === "readme")
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        aria-label="A readme file"
        viewBox="-18.0 -0.0 277.0 277.0"
        className={cls}
      >
  ...
  if (type === "yeti")
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        aria-label="yeti mascot riding scooter"
        viewBox="0 0 193 257"
        className={cls}
      >
